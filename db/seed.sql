INSERT INTO `tucker_db`.`customers` (`first_name`, `last_name`,`phone`, `email`, `password`, `role`) VALUES ('kostya', 'koby','202-650-9228', 'kos.koha@gmail.com', '1111','customer');
INSERT INTO `tucker_db`.`customers` (`first_name`, `last_name`,`phone`, `email`, `password`, `role`) VALUES ('alf', 'burg', '202-549-9855', 'alf_burga@gmail.com', '1111','customer');
INSERT INTO `tucker_db`.`customers` (`first_name`, `last_name`, `phone`, `email`, `password`, `role`) VALUES ('Mariya', 'Klyu','111-222-3333', 'mari92@gmail.com', '1111','customer');

INSERT INTO `tucker_db`.`addresses` (`street`, `city`, `state`, `zip_code`, `CustomerId`) VALUES ('121 Congressional ln', 'Rockville', 'MD', '20850', '1');
INSERT INTO `tucker_db`.`addresses` (`street`, `city`, `state`, `zip_code`, `CustomerId`) VALUES ('32 River Rd', 'Bethesda', 'MD', '32445', '3');
